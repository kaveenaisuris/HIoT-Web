                        ...
                        <br>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-5">
                                    <div class="form-outline">
                                        ...
                                        <input type="text"  value="{{ $entity->doctor->medical_id }}" name="register_id"id="form6Example1" class="form-control" readonly/>
                                ...
                                <div class="col-md-5">
                                    <div class="form-outline">
                                        ...
                                        <input type="text" name="mno" value="{{ $entity->doctor->mobile_no }}" id="form6Example2" class="form-control" readonly/>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <input type="text" name="hospital" value="{{ $entity->doctor->hospital }}" id="form6Example4" class="form-control" readonly/>
                                </div>
                            </div>
