        ...
        <div class="col-sm-12">
          <div class="card">
              <div class="card-header">
                ...
                <br>
                <div class="col-md-4">
                    <a class="nav-link" href="{{ route('doctor.create') }}"> <button class="btn btn-block btn-success">Add New</button></a>
                </div>
              <div class="card-body">
                  ...
                  <tbody>
                    @foreach($items as $user)
                      <tr>
                        ...
                        <td>{{ $user->country }}</td>
                        <td>
                          <a href="{{ route('doctor.show', $user->id) }}" class="btn btn-block btn-primary">View</a>
                        </td>
                        <td>
                          <a href="{{ 'doctor' . '/' . $user->id . '/edit' }}" class="btn btn-block btn-primary">Edit</a>
                        </td>
                        <td>
